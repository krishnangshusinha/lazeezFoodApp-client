  ...
  return (
    <div className="flex flex-col sm:flex-row justify-start gap-8">
      ...
      <div className="md:w-1/2 w-full space-y-3">
        ...
        <p className="text-white">Total Price: ${price}</p>
        <p className="text-white">Number of Items: {cart.length}</p>
      </div>
      ...
      <div className="md:w-1/2 w-full space-y-3 card shrink-0 w-full max-w-sm shadow-2xl bg-base-100 px-4 py-8">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={!stripe}
            className="btn btn-sm mt-5 bg-blue btn-primary w-full text-white"
          >
            Pay
          </button>
        ...
        <div className="mt-5 text-center">
          <hr />
          <button type="submit" className="btn btn-sm bg-blue mt-6 text-white">
